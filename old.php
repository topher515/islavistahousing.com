...
<?php if ( !$_GET['propid'] ) { # Upload a new property!
    ...
    <tr>
        ...
        <td class=right>
             ...
             Falf Baths: <input type="text" name="prophalfbathnum" size="8" class="textarea" value="# Half Baths" />
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class=right>
             <input type="file" name="theimage" size="35" class="textarea" />
        </td>
    </tr>
    <tr>
        <td class=left></td>
...
<?php } else { # edit this property's details ?>
...
<?php } else { # If this is a renter! ?>
    ...
    <tr>
        <td class=left>Address:</td>
        <td class=right>
	        <?php echo mysql_result($prop_result,0,'propAddressNum'); ?>
            <?php echo mysql_result($prop_result,0,'propAddressStreet'); ?>
    ...
    <tr>
        ...
        <td class=right>
			...
			<?php echo mysql_result($prop_result,0,'propBedroomLayout'); ?>.		
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class=left>Image:</td>
        <td class=right>
        	<span style="font-style:italic;">(images aren't working just yet)</span>
        </td>
    </tr>
    </form>
    </div>
